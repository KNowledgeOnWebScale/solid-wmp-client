import { BaseMonetizationEventDetail, Monetization, MonetizationProgressEventDetail, MonetizationState, MonetizationStopEventDetail } from 'types-wm';
...
export class MonetizationHandler {
    ...
    private startDetection() {
        ...
        if (!found) { this.setMonetizationState('stopped'); }
     ...
     */
    private setMonetizationState(state: MonetizationState, detail?: BaseMonetizationEventDetail | MonetizationStopEventDetail) {
        this.wm.state = state;
        let event: CustomEvent<BaseMonetizationEventDetail | MonetizationStopEventDetail>;
        switch (state) {
            case 'started':
